import book1 from "../img/book5.jpg";
import book2 from "../img/book4.jpg";
import book3 from "../img/book1.jpg";
import java from "../img/java.jpg";
import c from "../img/c.png";
import ml from "../img/ml.png";
import story from "../img/react1.jpg";
...
const Home = () => {
  return (
    <div>
      ...
      <p className="fs-3 text-center">New Books</p> 
        <div className="row">
